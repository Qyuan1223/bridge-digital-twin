#!/usr/bin/env python3
"""
Measure real-world placement poses for test_001.
...
Run on JetMax:
    rosrun jetmax_demos tune_test001_place_poses.py --start-step 1 --redo-existing
...
ROS_NODE_NAME = "tune_test001_place_poses"
OUT_PATH = os.path.join("calibration", "test_001_place_poses.json")
...
TEST_001 = [
    {"step": 1, "brick": "A'", "side": "L", "wx": 7.5, "wz": 1.5642247142857144},
    {"step": 2, "brick": "A'", "side": "R", "wx": 40.5, "wz": 1.5642247142857144},
    {"step": 3, "brick": "B'", "side": "L", "wx": 15.5, "wz": 1.5642247142857142},
    {"step": 4, "brick": "B'", "side": "R", "wx": 48.5, "wz": 1.5642247142857142},
    {"step": 5, "brick": "E", "side": "R", "wx": 45.0, "wz": 2.801403862549198},
    {"step": 6, "brick": "E", "side": "L", "wx": 12.0, "wz": 2.801403862549198},
    {"step": 7, "brick": "C'", "side": "L", "wx": 6.5, "wz": 3.41999343668094},
    {"step": 8, "brick": "E", "side": "R", "wx": 39.0, "wz": 4.0385830108126815},
    {"step": 9, "brick": "A'", "side": "L", "wx": 7.5, "wz": 5.275762159076165},
    {"step": 10, "brick": "F'", "side": "R", "wx": 36.5, "wz": 5.894351733207907},
    {"step": 11, "brick": "F'", "side": "L", "wx": 6.5, "wz": 7.131530881471391},
]
...
def load_state():
    ...
    state = {
        "version": 1,
        "updated_at": now_iso(),
        "notes": "Measured real-world placement poses for test_001.",
        "steps": steps,
    }
...
def parse_args():
    parser = argparse.ArgumentParser(description="Tune test_001 real-world placement poses.")
    parser.add_argument("--start-step", type=int, default=None, help="start from this test_001 step number")
